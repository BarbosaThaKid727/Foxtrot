        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li> 
   <a href="Goods.php">CHECK AVAILABLE JOBS</a>
  </li>
            </div> 
        </div>
    </div>
   ...
   <div id="basic-info">
       <div class="container">
                ...
                <div class="col-md-8 col-md-offset-2 " >
                    <h1>Welcome Hey Hello</h1>
                    <h4 style ="color:white">
                       <p>    We'll help you find the best jobs.Continue to options to find the best affordable carriers.</p>
                    </h4>
                </div>
            </div>
           </div>
