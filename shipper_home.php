        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li> <button onclick="myFunction()" class="dropbtn">OPTIONS</button>
  <div id="myDropdown" class="dropdown-content">
    <a href="map.php">Job Progress</a>
    <a href="job_posts.php">Check Job</a>
    <a href="job_registration.php">Upload Job</a>
                    </ul>
            </div> 
        </div>
    </div>
       ...
       <div class="container">
                ...
                <div class="col-md-8 col-md-offset-2 " >
                    ...
                    <h4 style ="color:white">
                       <p>             We'll help you transport goods from the comfort of your own home.</p>
                    </h4>
                </div>
            </div>
           </div>
